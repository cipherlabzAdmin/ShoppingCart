    ...
    <Col lg='6'>
      <div className='view-image-slider'>
        <Slider asNavFor={nav2} ref={(slider) => (slider1.current = slider)}>
           <Image src={cloneVariation?.product.imageURL ? cloneVariation?.product.imageURL : placeHolderImage} className='img-fluid' alt={cloneVariation?.product?.name} width={500} height={500} />
