...
const ExtraItemTableComponent = ({ warehouseId, deliveryId }) => {
  ...
  const handleCreateExtraItems = async () => {
    ...
    try {
      const response = await axios.post(
        `${baseUrl}services/ecommerce/extraItem/Create`,
        formData,
        {
          headers: {
  ...
  return (
    <div>
      ...
      <button onClick={handleCreateExtraItems} className="btn btn-sm text-white bg-success">
        Save Extra Items
      </button>
    </div>
  );
...
export default ExtraItemTableComponent;
