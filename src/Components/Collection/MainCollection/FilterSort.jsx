...
const FilterSort = ({ filter, setFilter }) => {
  ...
  const [attribute, price, category, layout, id] = useCustomSearchParams(['attribute', 'price', 'category', 'layout', 'id']);
  ...
  return (
    <div className='category-dropdown'>
      <h5 className='text-content' style={{color: 'var(--theme-color)'}}>{t('SortBy')} :</h5>
